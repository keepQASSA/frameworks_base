...
public class BatteryMeterDrawableBase extends Drawable {
    ...
    public static final int BATTERY_STYLE_LANDSCAPEL = 22;
    public static final int BATTERY_STYLE_LANDSCAPEM = 23;
    public static final int BATTERY_STYLE_LANDSCAPEN = 24;
    public static final int BATTERY_STYLE_LANDSCAPEO = 25;
    public static final int BATTERY_STYLE_CIRCLE = 26;
    public static final int BATTERY_STYLE_BIG_CIRCLE = 27;
    public static final int BATTERY_STYLE_DOTTED_CIRCLE = 28;
