...
public class PropImitationHooks {
    ...
    private static void setCertifiedPropsForGms() {
        if (sDisableGmsProps) {
            ...
            setSystemProperty(PROP_SECURITY_PATCH, SystemProperties.get("ro.kasa.custom_version"));
            setSystemProperty(PROP_FIRST_API_LEVEL,
                    Integer.toString(Build.VERSION_CODES.M));
            return;
        }
    ...
    private static boolean isGmsAddAccountActivityOnTop() {
        try {
            final ActivityManager.StackInfo focusedTask =
